...
import json
import re
import ast  # For fallback parsing

TOGETHER_API_KEY = "f911b02e47529b2fd90620523a399ee695074ea45ab2b3b5873df3ead8911de5"  # 🔑 Replace with your actual key
TOGETHER_API_URL = "https://api.together.xyz/v1/chat/completions"
TOGETHER_MODEL = "mistralai/Mistral-7B-Instruct-v0.1"  # You can change to other models on their dashboard

def get_text_from_url(url):
    """Scrape and clean text content from a website"""
...
def enrich_lead(domain):
    """Use Together.ai model to extract structured info and compute enrichment score"""
    ...
    try:
        ...
        try:
            ...
            try:
                ...
                # fallback parsing with ast.literal_eval
        ...
        # Compute a simple enrichment score
        score = 0
